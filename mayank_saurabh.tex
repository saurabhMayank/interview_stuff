...
\begin{tightemize}
    ...
    \item Team recieved \custombold {appreciation token} from the company for setting up qualitative process and speedy deliverable
\end{tightemize}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
...
\item Developed \custombold{model} integration and functional tests in Geb and Spock,used as an example for writing tests across GDBxT Development team in Pfizer
\item Team received \custombold{appreciation} from Pfizer for completing features and tests in the module 3 months before production deployment deadline.
  \item Led to recurring \custombold{renewal} of project, which started as a pilot
\end{tightemize}
